<aside id="logo-sidebar"
    ...
    <div class="overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('notes') }}" :active="request() - > routeIs('notes')""
                    ...
                    <span class="ml-3">{{ __('Notes') }}</span>
                </a>
            </li>
            <li>
                <a href="{{ route('events') }}" :active="request() - > routeIs('events')"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <svg aria-hidden="true"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">{{ __('Events') }}</span>
                </a>
            </li>
            <li>
                <a href="{{ route('contacts') }}" :active="request() - > routeIs('contacts')"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <svg aria-hidden="true"
                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">{{ __('Contacts') }}</span>
                </a>
            </li>
            <li>
                <a href="{{ route('companies') }}" :active="request() - > routeIs('companies')"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <svg aria-hidden="true"
                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">{{ __('Companies') }}</span>
                </a>
            </li>
        </ul>
    </div>

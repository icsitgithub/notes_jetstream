                ...
                <article class="w-full max-w-sm px-4 py-3 rounded-md shadow-md bg-white border border-gray-600">
                    <div>
                        ...
                        <div>
                            ...
                            <p class="font-normal text-gray-700 dark:text-black"><i class="fa-solid fa-thumbtack"></i>
                                {{ $contact->title }} </p>
                            <p class="font-normal text-gray-700 dark:text-black"><i class="fa-solid fa-phone"></i>
                                {{ $contact->phone_number }} </p>
                            <p class="font-normal text-gray-700 dark:text-black"><i class="fa-solid fa-envelope"></i>
                                {{ $contact->email }} </p>
                        </div>
